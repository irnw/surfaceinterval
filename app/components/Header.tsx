      ...
      <div className="masthead-inner">
        ...
        <div className="masthead-right">
          <nav className="nav">
            ...
            <Link
              href="/category/diving"
              className={navLinkClass(pathname, "/category/diving")}
            >
              Diving
            </Link>
            ...
            <Link
              ...
              className={navLinkClass(pathname, "/category/travel")}
            >
              Travel
            </Link>
            ...
            <Link
              href="/category/gear"
              className={navLinkClass(pathname, "/category/gear")}
            >
              Gear
            </Link>
